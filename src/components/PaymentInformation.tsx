...
const PaymentInformation = () => {
  ...
  return (
    <div>
      <div className="flex lg:hidden items-center justify-center relative py-7">
        <svg
          width="16"
          height="16"
          viewBox="0 0 20 20"
      ...
      <div className="flex flex-col lg:flex-row items-start gap-6 lg:mx-24 mx-6 pb-14">
        ...
        <div className="flex flex-col lg:w-7/12 w-full shrink-0 gap-6">
          {/* Discount code */}
          <div className="lg:flex items-center gap-56 border border-gray_4 rounded-lg lg:py-7 px-6">
            <div className="flex items-center gap-2 border-b border-gray_4 lg:border-none py-3">
              <img src={discountShape} alt="کدتخفیف" className="w-5 lg:w-7" />
              <p className="text-gray_8 lg:text-lg">ثبت کد تخفیف</p>
            </div>
            <form action="discount-code" className="flex items-center gap-5 py-4">
              <input
                type="text"
                className="border border-gray_4 rounded lg:h-11 h-10 lg:w-80 w-full placeholder:text-gray_7 
                        outline-none px-4 text-gray_7 placeholder:text-sm lg:placeholder:text-base"
                placeholder="کد تخفیف"
              />
              <button className="text-sm lg:text-base text-white bg-primary px-3 whitespace-nowrap lg:px-6 
                                rounded lg:h-11 h-10">
                ثبت کد
              </button>
            </form>
          </div>
          {/* Peyment method */}
          <div className="lg:flex items-center justify-between border border-gray_4 rounded-lg lg:pr-6 lg:pl-14 
                          lg:py-7 px-6">
            <div className="flex items-center gap-2 border-b border-gray_4 lg:border-none py-3">
            ...
            <form action="shipping-method" className="flex items-center justify-around gap-8 lg:gap-16 py-4">
              <div className="flex items-center gap-1 lg:gap-3">
                ...
                />
                <label htmlFor="courier" className="text-gray_7 text-sm lg:text-base leading-8">
                  پرداخت اینترنتی
              ...
              <div className="flex items-center gap-1 lg:gap-3">
                <input
                  ...
                  className="w-4 h-4 appearance-none rounded-full border cursor-pointer
                          border-gray_4 checked:bg-success_light bg-clip-content checked:p-px"
                />
                <label htmlFor="inPerson" className="text-gray_7 text-sm lg:text-base leading-8">
                  پرداخت در محل
                  <span className="hidden lg:block text-xs">
                    توسط پیک رستوران ارسال شود.
                  </span>
          ...
          {selectedOption === "courier" ? (
            <div className="border border-gray_4 rounded-lg px-6 py-3 lg:py-6">
              <div className="flex items-center gap-2 border-b border-gray_4 lg:border-none pb-3 lg:p-0">
                <img src={card} alt="درگاه پرداخت" className="w-5 lg:w-7" />
                <p className="lg:text-lg font-semibold lg:font-normal text-gray_8">درگاه پرداخت</p>
              </div>
              <div className="flex items-center justify-center gap-4 pt-4 lg:p-0">
                {banks.map((bank: any) => (
                  <img
                    key={bank.id}
                    src={bank.src}
                    className={`border rounded cursor-pointer w-20 lg:w-28 ${
              ...
              <div className="text-center pt-2">
                <p className="text-gray_7 text-xs lg:text-sm">
            ...
            <div className="lg:flex items-center justify-between gap-20 border border-gray_4 bg-gray_1
                            rounded-lg px-6 lg:py-7">
              <div className="flex items-center gap-2 border-b border-gray_4 lg:border-none py-2 lg:p-0">
                <svg
                  width="32"
                  height="32"
                  viewBox="0 0 24 24"
                ...
                <h3 className="text-gray_8 whitespace-nowrap lg:text-lg">
                  قابل توجه
                </h3>
              </div>
              <p className="text-gray_7 text-xs py-3 lg:p-0">
